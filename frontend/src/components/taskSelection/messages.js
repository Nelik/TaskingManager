...
export default defineMessages({
  ...
  taskStatus_WAITING_FOR_DEPENDENCIES: {
    id: 'project.tasks.status.waitingForDependencies',
    defaultMessage: 'Waiting for dependecies',
  },
  ...
  mappingStageQuestion: {
    id: 'project.tasks.action.options.mapping_stage_question',
    defaultMessage: 'Are those steps done?',
  },
  mappingStage1: {
    id: 'project.tasks.action.options.mapping_stage_1',
    defaultMessage: 'Mapped all crossroads.',
  },
  mappingStage2: {
    id: 'project.tasks.action.options.mapping_stage_2',
    defaultMessage: 'Mapped all sidewalks.',
  },
  mappedQuestion: {
